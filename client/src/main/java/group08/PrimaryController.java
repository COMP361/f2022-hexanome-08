...
public class PrimaryController {
    ...
    /**
     * The logic of handling log in. The methods check if the user has input both username and user password or not
    ...
    protected void onLogInButtonClick() throws IOException {
        ...
        else App.setRoot("splendor_game_board");
    ...
    /**
     * Displays the options of actions the player can do once they click on a regular development card (not orient)
     * @throws IOException IOException if fxml file not found
     */
    @FXML
