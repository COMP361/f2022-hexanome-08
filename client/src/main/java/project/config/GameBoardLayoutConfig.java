...
public class GameBoardLayoutConfig {
  ...
  private double pacBoardLayoutX;
  private double pacBoardLayoutY;
  private double nobleWidth;
  private double nobleHeight;
  private double tokenBankWidth;
  private double tokenBankHeight;
  private double topPlayerWidth;
  private double topPlayerHeight;
  private double btmPlayerWidth;
  private double btmPlayerHeight;
  private double rightPlayerWidth;
  private double rightPlayerHeight;
  private double leftPlayerWidth;
  private double leftPlayerHeight;
  private double baseCardBoardWidth;
