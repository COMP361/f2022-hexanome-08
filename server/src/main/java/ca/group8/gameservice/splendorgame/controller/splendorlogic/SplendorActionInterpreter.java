...
public class SplendorActionInterpreter {
   ...
   * @param playerState        the player specific game state that might be changed from
  ...
  //
  //public SplendorActionInterpreter(Action paramAction,
  // List<Action> paramActionList, GameInfo paramGameInfo) {
